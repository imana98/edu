                      ...
                      <div class="flex flex-wrap -m-4">
                        ...
                        <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                          <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                            ...
                            @if ($seminar->seminar_id === $entry->seminar_id && $seminar->id === $entry->detail_id)
                            <div class="flex justify-end mt-10 mb-6">
                              <button class="flex text-white bg-red-500 border-0 py-2 px-8 focus:outline-none rounded text-lg" disabled>選択中</button>
                            </div>
                            @else
