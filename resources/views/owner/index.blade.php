                      ...
                      @endif
                        <div class="flex-grow sm:text-left text-center mt-6 mb-4 p-2 sm:mt-0">
                          ...
                          <div class="flex justify-end mb-8">
                            <button onclick="location.href='{{ route('owner.seminars.create', ['id' => $seminar->id]) }}'" class="flex text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">講義を作成／編集する</button>
                          </div>
                          @endif
                        </div>
                    </div>
