                  ...
                  <section class="text-gray-600 body-font relative">
                    <div class="container px-5 py-4 mx-auto">
                      <div class="flex flex-col text-center w-full mb-12">
                        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">教員登録フォーム</h1>
                        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">新しく教員一覧に登録する先生の情報を入れてください。<br>登録後、パスワードを教員にお伝えください。</p>
                      </div>
                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                          <div class="-m-2">
                            ...
                            <div class="p-2 w-full mt-10 flex justify-around">
                              <button type="button" onclick="location.href='{{ route('admin.users.index') }}'" class="flex mx-auto text-white bg-gray-400 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">管理画面に戻る</button>
