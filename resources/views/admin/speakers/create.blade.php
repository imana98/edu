                  ...
                  <section class="text-gray-600 body-font relative">
                    <div class="container px-5 py-4 mx-auto">
                      <div class="flex flex-col text-center w-full mb-12">
                        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">講義者登録フォーム</h1>
                        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">新しく講義者として登録する先生の情報を入れてください。<br>登録後、パスワードを講義者にお伝えください。</p>
                      </div>
                              ...
                              <div class="relative">
                                ...
                                <select name="name" id="name">
                                    @foreach ($teachers as $teacher)
                                      <option value="{{ $teacher->name }}" name="name">{{ $teacher->name }}</option>
                                    @endforeach
                                  </select>
